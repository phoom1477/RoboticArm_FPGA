...
<drawing version="7">
    ...
    <netlist>
        ...
        <signal name="XLXN_88" />
        <signal name="XLXN_89" />
        <port polarity="Input" name="NE" />
        <port polarity="Input" name="NF" />
        <port polarity="Input" name="NC" />
        <port polarity="Output" name="Q(3:0)" />
        <port polarity="Input" name="ND" />
        <blockdef name="inv">
        ...
        <block symbolname="inv" name="XLXI_27">
            <blockpin signalname="ND" name="I" />
            <blockpin signalname="XLXN_82" name="O" />
        </block>
        <block symbolname="inv" name="XLXI_28">
            <blockpin signalname="NE" name="I" />
            <blockpin signalname="XLXN_86" name="O" />
        </block>
        <block symbolname="inv" name="XLXI_26">
            <blockpin signalname="NC" name="I" />
        ...
        <block symbolname="xor2" name="XLXI_33">
            <blockpin signalname="NF" name="I0" />
            <blockpin signalname="NE" name="I1" />
        ...
        <block symbolname="xor2" name="XLXI_36">
            <blockpin signalname="NF" name="I0" />
            <blockpin signalname="ND" name="I1" />
        ...
        <block symbolname="vcc" name="XLXI_38">
            <blockpin signalname="Q(2)" name="P" />
        </block>
    ...
    <sheet sheetnum="1" width="3520" height="2720">
        ...
        <iomarker fontsize="28" x="416" y="416" name="NC" orien="R180" />
        <iomarker fontsize="28" x="416" y="832" name="NE" orien="R180" />
        <iomarker fontsize="28" x="416" y="1024" name="NF" orien="R180" />
        <iomarker fontsize="28" x="416" y="592" name="ND" orien="R180" />
        <branch name="Q(1)">
        ...
        <instance x="2560" y="1344" name="XLXI_38" orien="R0" />
        <branch name="Q(3)">
        ...
        <instance x="2560" y="1536" name="XLXI_39" orien="R0" />
        <branch name="NF">
