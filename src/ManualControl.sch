...
<drawing version="7">
    ...
    <netlist>
        ...
        <blockdef name="DIV_500k">
            <timestamp>2020-12-15T18:46:46</timestamp>
        ...
        <block symbolname="Counter_FB_8Bits" name="XLXI_1">
            ...
            <blockpin signalname="XLXN_256" name="CLK" />
        ...
        <block symbolname="FullAdder8Bit" name="XLXI_6">
            ...
            <blockpin signalname="XLXN_209(7:0)" name="S(7:0)" />
            <blockpin name="CO" />
        </block>
        <block symbolname="buf" name="XLXI_51(7:0)">
            <blockpin signalname="XLXN_209(7:0)" name="I" />
            <blockpin signalname="OUTPUT(7:0)" name="O" />
        </block>
        <block symbolname="compm8" name="XLXI_19">
            <blockpin signalname="XLXN_209(7:0)" name="A(7:0)" />
            <blockpin signalname="StartValue(7:0)" name="B(7:0)" />
        ...
        <block symbolname="and4" name="XLXI_59">
            ...
            <blockpin signalname="EN" name="I3" />
            <blockpin signalname="XLXN_256" name="O" />
        </block>
        <block symbolname="DIV_500k" name="XLXI_60">
            <blockpin signalname="FPGA_CLK" name="CLK_IN" />
            <blockpin signalname="XLXN_245" name="CLK_OUT" />
        </block>
    </netlist>
    <sheet sheetnum="1" width="3520" height="2720">
        ...
        <branch name="DOWN">
            ...
            <wire x2="1824" y1="592" y2="592" x1="912" />
        ...
        <branch name="XLXN_75(7:0)">
            <wire x2="2272" y1="592" y2="592" x1="2208" />
            <wire x2="2272" y1="592" y2="1168" x1="2272" />
            <wire x2="2320" y1="1168" y2="1168" x1="2272" />
        </branch>
        ...
        <branch name="StartValue(7:0)">
            <wire x2="2176" y1="1232" y2="1232" x1="384" />
            <wire x2="2320" y1="1232" y2="1232" x1="2176" />
            <wire x2="2176" y1="1232" y2="1680" x1="2176" />
            <wire x2="2336" y1="1680" y2="1680" x1="2176" />
        </branch>
        <instance x="2336" y="2272" name="XLXI_18" orien="R0" />
        <branch name="EndValue(7:0)">
            <wire x2="2336" y1="2144" y2="2144" x1="384" />
        </branch>
        <iomarker fontsize="28" x="368" y="1440" name="FPGA_CLK" orien="R180" />
        <branch name="EN">
            <wire x2="1312" y1="512" y2="512" x1="336" />
            <wire x2="1312" y1="512" y2="624" x1="1312" />
        </branch>
        <branch name="FPGA_CLK">
            <wire x2="784" y1="1440" y2="1440" x1="368" />
        </branch>
        <instance x="1824" y="752" name="XLXI_1" orien="R0">
        </instance>
        <branch name="XLXN_196">
            <wire x2="1792" y1="656" y2="960" x1="1792" />
            <wire x2="1824" y1="656" y2="656" x1="1792" />
        </branch>
        <instance x="1728" y="1088" name="XLXI_50" orien="R0" />
        <branch name="XLXN_256">
            <wire x2="1696" y1="720" y2="720" x1="1568" />
            <wire x2="1824" y1="720" y2="720" x1="1696" />
        </branch>
        <branch name="XLXN_245">
            <wire x2="1312" y1="1440" y2="1440" x1="1168" />
            <wire x2="1312" y1="816" y2="1440" x1="1312" />
        </branch>
        <instance x="1312" y="880" name="XLXI_59" orien="R0" />
        <branch name="XLXN_200">
            <wire x2="1248" y1="944" y2="944" x1="1232" />
            <wire x2="1312" y1="752" y2="752" x1="1248" />
            <wire x2="1248" y1="752" y2="944" x1="1248" />
        </branch>
        <instance x="784" y="1472" name="XLXI_60" orien="R0">
        </instance>
    </sheet>
</drawing>