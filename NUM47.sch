...
<drawing version="7">
    ...
    <netlist>
        ...
        <signal name="XLXN_88" />
        <signal name="XLXN_89" />
        <port polarity="Input" name="N6" />
        <port polarity="Input" name="N7" />
        <port polarity="Input" name="N4" />
        <port polarity="Output" name="Q(3:0)" />
        <port polarity="Input" name="N5" />
        <blockdef name="inv">
        ...
        <block symbolname="inv" name="XLXI_27">
            <blockpin signalname="N5" name="I" />
            <blockpin signalname="XLXN_82" name="O" />
        </block>
        <block symbolname="inv" name="XLXI_28">
            <blockpin signalname="N6" name="I" />
            <blockpin signalname="XLXN_86" name="O" />
        </block>
        <block symbolname="inv" name="XLXI_26">
            <blockpin signalname="N4" name="I" />
        ...
        <block symbolname="xor2" name="XLXI_33">
            ...
            <blockpin signalname="N6" name="I1" />
        ...
        <block symbolname="xor2" name="XLXI_36">
            <blockpin signalname="N7" name="I0" />
            <blockpin signalname="N5" name="I1" />
    ...
    <sheet sheetnum="1" width="3520" height="2720">
        ...
        <iomarker fontsize="28" x="416" y="416" name="N4" orien="R180" />
        <iomarker fontsize="28" x="416" y="832" name="N6" orien="R180" />
        <iomarker fontsize="28" x="416" y="1024" name="N7" orien="R180" />
        <iomarker fontsize="28" x="416" y="592" name="N5" orien="R180" />
        <branch name="Q(1)">
